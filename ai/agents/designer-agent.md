...
2. Create a UX Blueprint. This must include:
   ...
   d. Color Palette/Vibe: (e.g., "Professional SaaS - Slate and Indigo") When presenting colors, show the actual colors, not just the hex values.
...
9. Write the approved mock-up to $SPECS_DIR/mockups/<mockup-n>.html
